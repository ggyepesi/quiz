 ...
 * of a datasource has nothing to do with being renderable. A {@code Source} is a
 * value, not a modeled field on the instance. Curation resolutions live in
 * curation history; acquisition may retain a source descriptor as hidden provenance
 * when the descriptor itself is needed to explain a generated record. A {@link
 * SourceFactory} produces the handle (identify), a {@link SourceProducer} consumes
 * it (pull).</p>
 *
