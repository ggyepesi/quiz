 ...
 * value, not state on the instance: an instance holds only its results, while the
 * source that produced or enriched it is recorded in the curation history. A
 * {@link SourceFactory} produces the handle (identify), a {@link SourceProducer}
 * consumes it (pull).</p>
 *
