...
public class QuizablePanelConfigJsonIO {
    ...
    public static void save(File file, QuizablePanelConfig config) {
        try {
    ...
    private static JsonConfig toJson(QuizablePanelConfig cfg) {
        ...
        for (Map.Entry<String, QuizablePanelConfig> e : cfg.getFields().entrySet()) {
