...
/**
 * Rendering hint for ViewablePanel, the opposite of {@link ViewableReference}.
 *
 ...
 * window). Annotate the field with @ViewableInline to instead expand each
...
public @interface ViewableInline {
}
