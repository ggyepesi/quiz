...
/**
 * Link row implemented on top of ViewableTextRow, so it inherits:
 * selection, search highlighting, wrapping, keyboard copy, and popup copy.
 */
public class ViewableLinkRow extends ViewableTextRow {
    ...
    private ViewableLinkRow(
        ...
        putClientProperty(
                ViewableSearchPanel.FIELD_VALUE_PROPERTY,
                this.url);
    }
