...
/**
 * Link row implemented on top of QuizableTextRow, so it inherits:
 * selection, search highlighting, wrapping, keyboard copy, and popup copy.
 */
public class QuizableLinkRow extends QuizableTextRow {
    ...
    private QuizableLinkRow(
        ...
        putClientProperty(
                QuizableSearchPanel.FIELD_VALUE_PROPERTY,
                this.url);
    }
