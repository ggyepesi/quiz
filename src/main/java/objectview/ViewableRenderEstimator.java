...
public final class ViewableRenderEstimator {

    private static final Logger log = LoggerFactory.getLogger(ViewableRenderEstimator.class);
    ...
    private ViewableRenderEstimator() {}
