...
public class ViewableGroupView extends JPanel {
    private final ViewableGroup<?> rootGroup;

    // lazy-created views
    private final Map<String, ViewablePanelView> groupViews = new TreeMap<>();
    ...
    public ViewableGroupView(ViewableGroup<?> rootGroup) {
    ...
    private void buildTree() {
        ...
        JButton showButton = new JButton("Show quizables");
    ...
    private void showGroup(String fullName) {
        ViewablePanelView view = groupViews.computeIfAbsent(fullName, this::createViewForGroup);
        if (view != null) {
            view.show(fullName, 2);
        }
    }

    private ViewablePanelView createViewForGroup(String fullName) {
