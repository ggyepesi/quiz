...
public class ViewablePanelConfigJsonIO {
    ...
    public static void save(File file, ViewablePanelConfig config) {
        try {
    ...
    private static JsonConfig toJson(ViewablePanelConfig cfg) {
        ...
        for (Map.Entry<String, ViewablePanelConfig> e : cfg.getFields().entrySet()) {
