...
public class QuizablePanelConfigEditorFrame extends JFrame {
    ...
    public QuizablePanelConfigEditorFrame(Viewable sample,
        ...
        QuizablePanelConfig config = initialConfig == null
                ? QuizablePanelConfig.of(sample.getClass())
                : initialConfig.copy();
    ...
    private QuizablePanelConfigEditor createEditor(QuizablePanelConfig config) {
        QuizablePanelConfigEditor e = new QuizablePanelConfigEditor(config);
    ...
    private void saveJson() {
        QuizablePanelConfig config = editor.getConfig();
        config.clearCache();

        java.io.File file =
                QuizablePanelConfigJsonIO.defaultFileFor(sample.getClass());

        QuizablePanelConfigJsonIO.save(file, config);
    ...
    private void resetToDefaults() {
        QuizablePanelConfig defaultConfig =
                QuizablePanelConfig.of(sample.getClass());
    ...
    private void refreshPreview() {
        ...
        QuizablePanel panel = new QuizablePanel(sample, config, true);
