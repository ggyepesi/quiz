...
/**
 * Demo of {@link MultiQuizableView}: a Constellations view and a Stars view
...
public class MultiQuizableViewDemo {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(MultiQuizableViewDemo::launch);
    }
    ...
    private static void launch() {
        ...
        JFrame frame = new JFrame(
                "MultiQuizableView demo — click a chip to navigate");
