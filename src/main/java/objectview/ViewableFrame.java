...
public class ViewableFrame {
    private static final Map<Viewable, WeakReference<JFrame>> openFrames = new IdentityHashMap<>();

    public ViewableFrame(Viewable q, ViewablePanelConfig cfg) {
        this(q.getName(), q, cfg);
    }

    public ViewableFrame(String title, Viewable quizable,
        ...
        ViewablePanel panel = new ViewablePanel(quizable, config, true, true);
