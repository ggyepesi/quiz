...
public class ViewableTextRow extends JComponent implements ViewableTextSelectable {

    private static final Logger log = LoggerFactory.getLogger(ViewableTextRow.class);
    ...
    private final ViewableTextSelection selection =
            new ViewableTextSelection();

    private int cachedWidth = -1;
    private List<PaintLine> cachedPaintLines = new ArrayList<>();

    public ViewableTextRow(String fieldName,
    ...
    public ViewableTextRow(String fieldName,
                           List<String> fieldPath,
                           List<String> lines) {
        ViewablePanel.RenderStats.textRows++;
        ...
        putClientProperty(ViewableSearchPanel.FIELD_NAME_PROPERTY, this.fieldName);
        putClientProperty(ViewableSearchPanel.FIELD_PATH_PROPERTY, this.fieldPath);
        putClientProperty(ViewableSearchPanel.FIELD_VALUE_PROPERTY,
                          String.join(" ", this.lines));

        addMouseListener(ViewableTextCopyMouseHandler.INSTANCE);
        addMouseMotionListener(ViewableTextCopyMouseHandler.INSTANCE);
    ...
    public void beginSelection(Point p) {
        ViewableTextSelectionManager.activate(this);
