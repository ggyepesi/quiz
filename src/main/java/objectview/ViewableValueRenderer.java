...
public final class ViewableValueRenderer {
    private ViewableValueRenderer() {
    }

    public static JComponent createFieldComponent(
            Set<Object> visited, Set<Object> ancestors, ViewableRenderContext renderContext,
            String fieldName, List<String> fieldPath, Object value,
            ViewablePanelConfig config, boolean fill) {
        if (value == null) {
            return null;
        }
    ...
    private static JComponent quizableComponent(
            Set<Object> visited, Set<Object> ancestors, ViewableRenderContext renderContext,
            String fieldName, List<String> fieldPath, Viewable q, ViewablePanelConfig config, boolean fill) {
    ...
    private static JComponent quizableComponent(
        ...
        ViewablePanel nested = new ViewablePanel(
    ...
    private static JComponent simpleCollectionComponent(String fieldName, List<String> fieldPath, Collection<?> collection) {
        ...
        return new ViewableTextRow(fieldName, new ArrayList<>(fieldPath), lines);
    }

    private static JComponent complexCollectionComponent(Set<Object> visited, Set<Object> ancestors, ViewableRenderContext renderContext, String fieldName, List<String> fieldPath, Collection<?> collection, ViewablePanelConfig config, boolean fill) {
    ...
    private static JComponent mapComponent(Set<Object> visited, Set<Object> ancestors, ViewableRenderContext renderContext, String fieldName, List<String> fieldPath, Map<?, ?> map, ViewablePanelConfig config, boolean fill) {
    ...
    private static JComponent simpleMapComponent(String fieldName, List<String> fieldPath, Map<?, ?> map) {
        ...
        return new ViewableTextRow(fieldName, new ArrayList<>(fieldPath), text);
    }

    private static JComponent createCollectionItemComponent(Set<Object> visited, Set<Object> ancestors, ViewableRenderContext renderContext, List<String> fieldPath, Object item, ViewablePanelConfig config, boolean fill) {
        if (item == null) {
            return null;
        }
        ...
        if (item instanceof Viewable q) {
            ...
            // of expanding in place (see ViewablePanel.collapsibleReference).
            ...
            // body's own title header (mirrors ViewablePanel.collapsibleReference).
    ...
    private static JComponent leafComponent(String fieldName, List<String> fieldPath, Object value) {
        ...
        return new ViewableTextRow(fieldName, new ArrayList<>(fieldPath), value);
    }
    ...
    private static JPanel basePanel(String fieldName, List<String> fieldPath, Object value) {
        ...
        panel.putClientProperty(ViewableSearchPanel.FIELD_NAME_PROPERTY, fieldName);

        panel.putClientProperty(ViewableSearchPanel.FIELD_PATH_PROPERTY, new ArrayList<>(fieldPath));

        panel.putClientProperty(ViewableSearchPanel.FIELD_VALUE_PROPERTY, value);
