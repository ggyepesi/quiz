...
/**
 * Non-UI helper for ViewableSearchPanel.
 *
 * It owns:
 ...
 */
public class ViewablePanelSearchAndSort {
    ...
    public void rebuildSearchIndex(
            ...
            ViewablePanelConfig searchConfig) {
    ...
    public Map<String, List<ViewablePanel>> search(
            List<String> queryTokens) {

        Map<String, List<ViewablePanel>> out =
                new LinkedHashMap<>();
    ...
    public Map<String, List<objectview.Viewable>> searchQuizables(
        ...
        for (ViewableFieldPaths.FieldPath fp
                ...
                quizables.get(0), ViewableFieldPaths.NOT_IMAGE_PANE_FIELDS)) {
    ...
    public List<ViewablePanel> sortPanels(
        ...
        for (ViewablePanel panel : panels) {
