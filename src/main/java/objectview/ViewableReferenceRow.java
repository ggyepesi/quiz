...
/**
 * A reference to another {@link Viewable}, rendered on top of {@link ViewableTextRow}
 ...
 * (handled by {@link ViewablePanel}), which is the rare case.
 */
public class ViewableReferenceRow extends ViewableTextRow {

    private static final Logger log = LoggerFactory.getLogger(ViewableReferenceRow.class);
    ...
    private final ViewablePanelConfig openConfig;
    ...
    public ViewableReferenceRow(String fieldName,
                                List<String> fieldPath,
                                Viewable target,
                                ViewableRenderContext renderContext,
                                ViewablePanelConfig openConfig,
                                String openTitle,
                                boolean expanded) {
    ...
    public ViewableReferenceRow(String fieldName,
        ...
        super(fieldName,
                ...
                List.of(name(target)));
        ViewablePanel.RenderStats.referenceRows++;
        ...
        searchPath.add("name");
        putClientProperty(ViewableSearchPanel.FIELD_PATH_PROPERTY, searchPath);
    }
    ...
    // Rebuilds the whole card in place (ViewablePanel#refresh) so the toggled
    // reference re-renders as a chip or an inline panel.
    private void refreshRootCard() {
        ViewablePanel root = null;
    ...
    private void openFullObject() {
        ...
        new ViewableFrame(
                target,
                ViewablePanelConfig.allWithMinorFields(target.getClass())
                                   .setAddListener(true)
                                   .setThumb(true));
    }
