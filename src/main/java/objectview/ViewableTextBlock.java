...
public class ViewableTextBlock extends JComponent implements ViewableTextSelectable {
    ...
    public ViewableTextBlock(List<Row> rows) {
        if (rows != null) {
            this.rows.addAll(rows);
        }
        ViewablePanel.RenderStats.textBlocks++;
        setOpaque(false);
        setFocusable(true);

        putClientProperty(ViewableSearchPanel.FIELD_NAME_PROPERTY, "textBlock");
        putClientProperty(ViewableSearchPanel.FIELD_VALUE_PROPERTY, this);
